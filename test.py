...
parser.add_argument('--normal_results_path', type=str, default='./results/my_single_scale_normal_stn/', help='Log dir [default: log]')
parser.add_argument('--data_path', type=str, default='./pclouds', help='Relative path to GT data directory')
...
for dataset in dataset_list:
    ...
    LOG_FOUT = open(os.path.join(outdir, dataset + '_evaluation_pcpnet_results_stn.txt'), 'w')
    if EXPORT:
